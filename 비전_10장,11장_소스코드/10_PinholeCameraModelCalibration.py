...
pattern_size = (10, 7)
samples = []
file_list = os.listdir('C:/Users/dudau/Downloads/Vision/Data/data/pinhole_calib')
...
for filename in img_file_list:
    ...
    frame = cv2.imread(os.path.join('C:/Users/dudau/Downloads/Vision/Data/data/pinhole_calib', filename))
